...
timespec inputTime[8] = { 0 };
int inputReadings[8] = { 0 };
...
int SensorChangeHandler(CPhidgetInterfaceKitHandle IFK, void *usrptr, int i, int v)
{
    ...
    handler->SensorChangeHandler(i, v);
    /*
    sensorReadings[i] = v;*/
    return 0;
}
...
int InputChangeHandler(CPhidgetInterfaceKitHandle IFK, void *usrptr, int i, int v)
{
    ...
    InterfaceKitCallbackHandler* handler = (InterfaceKitCallbackHandler*)usrptr;
    handler->InputChangeHandler(i, v);
    
    /*
    inputReadings[i] = v;
    clock_gettime(CLOCK_MONOTONIC, &inputTime[i]);*/
...
void initDistanceSensors(InterfaceKitCallbackHandler* handler)
{
    ...
    CPhidgetInterfaceKit_set_OnSensorChange_Handler(ifKit, SensorChangeHandler, handler);
    CPhidgetInterfaceKit_set_OnInputChange_Handler(ifKit, InputChangeHandler, handler);
